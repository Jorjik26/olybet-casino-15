...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-147fcb4a');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-147fcb4a');}
...
var brandEl=document.querySelector('.rl-brand-147fcb4a');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
